-- Filetypes for which to enable Treesitter highlighting and folding
local pattern = {'lua','cpp','python','js','javascript','typescript','javascriptreact','tsx','html','css','rust','go','sh','markdown','yaml','toml'}
